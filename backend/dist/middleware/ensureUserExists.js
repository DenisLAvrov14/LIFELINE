...
const ensureUserExists = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const resultById = yield db_connection_1.default.query(queryById, [
        userId,
      ]);
      if (((_a = resultById.rowCount) !== null && _a !== void 0 ? _a : 0) > 0) {
        console.log(
          `🟢 [ensureUserExists] Пользователь найден по ID: ${userId}`,
        );
      ...
      const resultByEmail = yield db_connection_1.default.query(queryByEmail, [
        email,
      ]);
      if (
        ((_b = resultByEmail.rowCount) !== null && _b !== void 0 ? _b : 0) > 0
      ) {
        console.log(
      ...
      const insertQuery = `
            ...
            VALUES ($1, $2, $3)
        `;
      yield db_connection_1.default.query(insertQuery, [
        userId,
        preferredUsername,
        email,
      ]);
