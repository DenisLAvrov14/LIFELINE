...
router.post(
  ...
  task_times_controller_1.createTaskTimeController,
);
// Обновление времени выполнения задачи
router.post(
  "/update-task-time",
  task_times_controller_1.updateTaskTimeController,
);
// Обновление статуса таймера (пауза/возобновление)
router.post(
  "/update-timer",
  task_times_controller_1.updateTimerStatusController,
);
...
router.put(
  "/tasks/:id/done",
  authenticateToken_1.authenticateToken,
  task_times_controller_1.markTaskAsDone,
);
